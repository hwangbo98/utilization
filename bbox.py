...
img_path = "/home/hwangbo/Big.jpeg"

json_path = "/home/hwangbo/output/Big.json"
...
for k, human_box in enumerate(data["human_info"]) :
    ...
    img = cv2.line(img, (lf_waist_x, lf_waist_y), (rh_waist_x, rh_waist_y), rc, 5)
...
cv2.imwrite("/home/hwangbo/output/" + img_path.split('/')[-1].split('.')[0] + '.jpg', img)